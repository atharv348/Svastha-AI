...
from routers import users, token, workout, meals, coach, progress, predictions, sahayak, manasmitra, enhanced_health, svasthaquest, medical_report
...
os.makedirs("uploads/vaidyaai_predictions", exist_ok=True)
...
# Static files for image previews

...
from database import get_db, User, Prediction, ClinicalPrediction, SessionLocal
from .users import get_current_user
from pydantic import BaseModel
import sys
import json
from schemas import ClinicalPredictionCreate, ClinicalPredictionResponse, DiseaseRisk, MedicalReport
...
def _get_checkpoint_candidates(body_part: str) -> List[str]:
    ...
    candidates = [
        os.path.join(BASE_DIR, "models", f"{canonical_part}_best_model.pth"),
        os.path.join(BASE_DIR, "models", f"{body_part}_best_model.pth"),
    ]
